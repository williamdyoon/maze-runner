...
CloudflareApps.siteId = 'fa0a36cc493ea9cc4880ede5bf942e3e';
...
CloudflareApps.installs['hOjILl3D01OR'] = { appId: 'lMxPPXVOqmoE', scope: {} };
CloudflareApps.installs['hOjILl3D01OR'].options = { id: '', social: false };
if (
  CloudflareApps.matchPage(CloudflareApps.installs['hOjILl3D01OR'].URLPatterns)
) {
  (function () {
    var options = CloudflareApps.installs['hOjILl3D01OR'].options;
    var id;
